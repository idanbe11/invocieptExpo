...
function DraggableFlatListProvider(_a) {
    var activeKey = _a.activeKey, onDragEnd = _a.onDragEnd, keyExtractor = _a.keyExtractor, horizontal = _a.horizontal, children = _a.children;
    ...
    return (react_1.default.createElement(DraggableFlatListContext.Provider, { value: value }, children));
}
exports.default = DraggableFlatListProvider;
function useDraggableFlatListContext() {
    var value = (0, react_1.useContext)(DraggableFlatListContext);
    if (!value) {
